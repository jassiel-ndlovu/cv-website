...
export default function Drawing() {
  ...
  useEffect(() => {
    ...
    if (!hovering) {
      timer = setTimeout(() => setFlipped(prev => !prev), 11000);
    }
  ...
  return (
    <div
      className={`w-full h-48 shrink-0 card ${flipped ? "flipped" : ""}`}
    ...
    >
      <div className="card-inner">
        ...
        {/* Back */}
        <div 
          className="card-face card-back bg-primary-color"
        >
          <div className="w-full h-full p-2 flex flex-col justify-end bg-gradient-to-b from-transparent via-transparent to-black/70">
            <p className="text-sm text-white">Follow me on <a className="underline" href="https://www.instagram.com/jassielndlovu/">Instagram</a> or connect with me on <a className="underline" href="https://www.linkedin.com/in/nkosenhle-ndlovu-8a0745290/">LinkedIn</a>.</p>
          </div>
        </div>
      </div>
    </div>
