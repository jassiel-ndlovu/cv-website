...
export default function Nav() {
  ...
  return (
    <div className="w-full my-2">
      <nav className="flex items-center gap-8 mx-auto w-fit py-1 px-4 rounded-2xl bg-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.1)] backdrop-blur-[5px] border border-white/30">
